...
- I want to be able to leave comments on articles.
...
- clicking on any of the events at the bottom of the page displays the upcoming events, including the date, time, location, and a brief description. Users can comment here if they're logged in, other they can only read comments by other logged in users.
...
- The gallery page displays a collection of photos from various travel destinations and past event.
![Responsive Image](https://github.com/passportpowell/Passport-Powell/blob/main/readme-images/amiresponsive_old.jpg)

- The registration form can be accessed by clicking on the "Register" button on the navigation bar. The user will be prompted to enter their username, email address, and password.
![Responsive Image](https://github.com/passportpowell/Passport-Powell/blob/main/readme-images/amiresponsive_old.jpg)
...
- The user can also leave comments on an event by filling out the comment form at the bottom of the event details page. These comments will be displayed on the event details page, and will need to be approved or rejected by an admin user.
![Responsive Image](https://github.com/passportpowell/Passport-Powell/blob/main/readme-images/amiresponsive_old.jpg)
...
### Imagery
- The homepage features a beautiful landscape image of Birmingham to set the tone for the site. The pre-written events feature thumbnails with images that are relevant to the pages topic.
...
- Issue: kept receveing error (AttributeError at /admin/blog/usercomment/add/'str' object has no attribute 'username'), when trying to post a UserComment: checking through the code i saw that i needed to change the user field to a foreign key in the User model
...
- be sure to add 
    ...
    and these to settings.py templates section
...
- In heroku go to deploy tab scroll down to connect app to github and at the bottom of the same page deploy branch.
